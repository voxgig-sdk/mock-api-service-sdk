// Command MockApiService-mcp is an MCP server exposing the MockApiService
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MockApiService_list  — list records of an entity
//	MockApiService_load  — load a single record of an entity
//
