...
type Args struct {
	Entity string         `json:"entity" jsonschema:"health | post | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MockApiServiceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mock-api-service_list",
		Description: "List records from MockApiService. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mock-api-service_load",
		Description: "Load a single record from MockApiService. " +
...
func runOp(client *sdk.MockApiServiceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MockApiServiceSDK, name string) (sdk.MockApiServiceEntity, error) {
