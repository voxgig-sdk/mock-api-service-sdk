...
// MockApiService SDK utility: graphql
//
...
class MockApiServiceGraphql
{
    ...
    // equivalent.
    public static function body(MockApiServiceContext $ctx): mixed
    {
    ...
    public static function errors(MockApiServiceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
