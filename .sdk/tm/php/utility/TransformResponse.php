...
// MockApiService SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MockApiServiceTransformResponse
{
    public static function call(MockApiServiceContext $ctx): mixed
    {
        ...
        $transform = MockApiServiceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
