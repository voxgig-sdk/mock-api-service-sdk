...
// MockApiService SDK utility: make_options

class MockApiServiceMakeOptions
{
    ...
    public static function call(MockApiServiceContext $ctx): array
    {
        ...
        //
        // `MockApiServiceSchema::optspec()` is built from the model:
        ...
        $optspec = MockApiServiceSchema::optspec();
