...
// MockApiService SDK utility type

class MockApiServiceUtility
{
    ...
    public static function copy(MockApiServiceUtility $src): MockApiServiceUtility
    {
        $u = new MockApiServiceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
