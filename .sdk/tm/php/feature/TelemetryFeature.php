...
// MockApiService SDK telemetry feature
...
class MockApiServiceTelemetryFeature extends MockApiServiceBaseFeature
{
    ...
    private function _close(MockApiServiceContext $ctx, bool $ok): void
    {
