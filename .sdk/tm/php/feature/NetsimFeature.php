...
// MockApiService SDK netsim feature
...
class MockApiServiceNetsimFeature extends MockApiServiceBaseFeature
{
    ...
    private function _simulate(MockApiServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MockApiServiceContext $ctx, array $applied): void
    {
        $client = $this->client;
