...
// MockApiService SDK rbac feature
...
class MockApiServiceRbacFeature extends MockApiServiceBaseFeature
{
    ...
    private function _required(MockApiServiceContext $ctx): ?string
    {
    ...
    private function _reject(MockApiServiceContext $ctx, string $required): void
    {
    ...
    private function _track(MockApiServiceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
