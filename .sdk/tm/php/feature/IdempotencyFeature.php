...
// MockApiService SDK idempotency feature
...
class MockApiServiceIdempotencyFeature extends MockApiServiceBaseFeature
{
    ...
    private function _mutating(MockApiServiceContext $ctx): bool
    {
