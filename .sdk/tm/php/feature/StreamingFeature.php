...
// MockApiService SDK streaming feature
...
class MockApiServiceStreamingFeature extends MockApiServiceBaseFeature
{
    ...
    private function _iterate(MockApiServiceResult $result): \Generator
    {
    ...
    private function _streamable(MockApiServiceContext $ctx): bool
    {
