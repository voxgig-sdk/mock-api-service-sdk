...
// MockApiService SDK paging feature
...
class MockApiServicePagingFeature extends MockApiServiceBaseFeature
{
    ...
    private function _is_list(MockApiServiceContext $ctx): bool
    {
