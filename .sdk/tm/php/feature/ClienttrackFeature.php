...
// MockApiService SDK clienttrack feature
...
class MockApiServiceClienttrackFeature extends MockApiServiceBaseFeature
{
    ...
    public function PostConstruct(MockApiServiceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MockApiService-SDK';
