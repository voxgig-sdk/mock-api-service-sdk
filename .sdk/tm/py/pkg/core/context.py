...
from projectname_sdk.core.control import MockApiServiceControl
...
class MockApiServiceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MockApiServiceControl()
        ...
        if isinstance(sp, MockApiServiceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MockApiServiceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MockApiServiceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MockApiServiceOperation({})
    ...
    def make_error(self, code, msg):
        return MockApiServiceError(code, msg, self)
