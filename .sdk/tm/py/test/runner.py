...
class MockApiServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MockApiServiceTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MockApiServiceTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MockApiServiceTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
