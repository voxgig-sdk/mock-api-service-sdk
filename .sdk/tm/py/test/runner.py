...
class MockApiServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MockApiServiceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MockApiServiceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MockApiServiceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
