...
|---|---|---|
| `ts/` | @voxgig-sdk/mock-api-service-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mock-api-service-sdk \
      --repository voxgig-sdk/mock-api-service-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mock-api-service-sdk` shows it, and
`npm trust revoke @voxgig-sdk/mock-api-service-sdk --id=<id>` removes it.
