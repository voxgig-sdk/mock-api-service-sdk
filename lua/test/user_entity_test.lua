...
describe("UserEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MOCK_API_SERVICE_TEST_USER_ENTID JSON to run live")
      return
    end
    ...
    local user_ref01_markdef_up0_name = "createdAt"
...
function user_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MOCK_API_SERVICE_TEST_USER_ENTID")
  ...
  if env["MOCK_API_SERVICE_TEST_LIVE"] == "TRUE" then
