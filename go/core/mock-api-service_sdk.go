...
func (sdk *MockApiServiceSDK) OptionsMap() map[string]any {
...
func (sdk *MockApiServiceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MockApiServiceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MockApiServiceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MockApiServiceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MockApiServiceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MockApiServiceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MockApiServiceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MockApiServiceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MockApiServiceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MockApiServiceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MockApiServiceSDK {
	...
	sdk := NewMockApiServiceSDK(sdkopts)
	sdk.Mode = "test"
