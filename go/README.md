...
## Install
```bash
go get github.com/voxgig-sdk/mock-api-service-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/mock-api-service-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/mock-api-service-sdk/go=../mock-api-service-sdk/go
```
...
| `User` | `(data map[string]any) MockApiServiceEntity` | Create an User entity instance. |
