...
const testSeed = `map[string]any{"entity": map[string]any{"health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
