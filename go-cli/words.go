...
func registerSDKWords(r *eng.Registry, client *sdk.MockApiServiceSDK) {
...
func runOp(client *sdk.MockApiServiceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
