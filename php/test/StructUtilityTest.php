...
// MockApiService SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MockApiServiceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MockApiServiceOmni::structfix($now, Struct::undef()))
                        !== json_encode(MockApiServiceOmni::structfix($val, Struct::undef()))) {
