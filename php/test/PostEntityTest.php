...
class PostEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MOCKAPISERVICE_TEST_POST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function post_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MOCKAPISERVICE_TEST_POST_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["MOCKAPISERVICE_TEST_POST_ENTID"]);
