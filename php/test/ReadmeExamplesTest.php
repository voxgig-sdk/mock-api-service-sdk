...
// MockApiService SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MockApiServiceSDK::test)
...
{
    private const SDK_CLASS = 'MockApiServiceSDK';
    ...
    private const SDK_BASE = 'mockapiservice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mockapiservice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
