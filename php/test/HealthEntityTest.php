...
class HealthEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MOCK_API_SERVICE_TEST_HEALTH_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function health_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MOCK_API_SERVICE_TEST_HEALTH_ENTID");
