...
// MockApiService SDK pipeline test
//
...
{
    private static function utility(): MockApiServiceUtility
    {
        return new MockApiServiceUtility();
    }
    ...
    private static function ctx(array $over = []): MockApiServiceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MockApiServiceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MockApiServiceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MockApiServiceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MockApiServiceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MockApiServiceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MockApiServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MockApiServiceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MockApiServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MockApiServiceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MockApiServiceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MockApiServiceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MockApiServiceResponse([]),
            'result' => new MockApiServiceResult([]),
        ]);
        [, $err] = MockApiServiceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MockApiServiceSpec([]),
            'response' => null,
            'result' => new MockApiServiceResult([]),
        ]);
        [, $err] = MockApiServiceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MockApiServiceSpec(['step' => 's']),
            'response' => new MockApiServiceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MockApiServiceResult([]),
        ]);
        [, $err] = MockApiServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MockApiServiceSpec(['step' => 's']),
            'response' => new MockApiServiceResponse(self::resp(200, ['v' => 1])),
            'result' => new MockApiServiceResult([]),
        ]);
        [, $err] = MockApiServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MockApiServiceSpec(['step' => 's']),
            'response' => new MockApiServiceResponse(self::resp(200, ['v' => 2])),
            'result' => new MockApiServiceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MockApiServiceMakeResponse::call($ctx);
    ...
    {
        $preset = new MockApiServiceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MockApiServiceSpec([]),
            'response' => new MockApiServiceResponse([]),
            'result' => new MockApiServiceResult([]),
        ...
        [$got, $err] = MockApiServiceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MockApiServiceResult([])]);
        [, $err] = MockApiServiceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MockApiServiceSpec([]), 'result' => null]);
        [, $err] = MockApiServiceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MockApiServiceSpec(['step' => 's']),
            'result' => new MockApiServiceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MockApiServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MockApiServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MockApiServiceSpec(['step' => 's']),
            'result' => new MockApiServiceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MockApiServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MockApiServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MockApiServiceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MockApiServiceSpec([]),
            'result' => new MockApiServiceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MockApiServiceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MockApiServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MockApiServiceError('boom', 'boom');
        $utility->fetcher = function (MockApiServiceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MockApiServiceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MockApiServiceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MockApiServiceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MockApiServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MockApiServiceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MockApiServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MockApiServiceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MockApiServiceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MockApiServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MockApiServiceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MockApiServiceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MockApiServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MockApiServiceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MockApiServiceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MockApiServiceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MockApiServiceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MockApiServiceResult(['ok' => false])]);
        $this->expectException(MockApiServiceError::class);
        MockApiServiceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MockApiServiceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MockApiServiceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MockApiServiceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MockApiServiceBaseFeature();
        $b = new MockApiServiceBaseFeature();
        MockApiServiceFeatureAdd::call($ctx, $a);
        MockApiServiceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MockApiServiceBaseFeature
    {
        $f = new MockApiServiceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MockApiServiceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MockApiServiceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MockApiServiceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MockApiServicePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MockApiServicePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MockApiServiceResponse(['headers' => null]),
            'result' => new MockApiServiceResult([]),
        ]);
        MockApiServiceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MockApiServiceResultBody::call($ctx);
