...
// MockApiService SDK utility: fetcher

class MockApiServiceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MockApiServiceSDK/1.0)';
    ...
    public static function call(MockApiServiceContext $ctx, string $fullurl, array $fetchdef): array
    {
