...
// MockApiService SDK proxy feature
...
class MockApiServiceProxyFeature extends MockApiServiceBaseFeature
{
    ...
    public function init(MockApiServiceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MockApiServiceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
