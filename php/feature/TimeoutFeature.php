...
// MockApiService SDK timeout feature
...
class MockApiServiceTimeoutFeature extends MockApiServiceBaseFeature
{
    ...
    private function _with_timeout(MockApiServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MockApiServiceContext $_ctx, float $ms): void
    {
        $client = $this->client;
