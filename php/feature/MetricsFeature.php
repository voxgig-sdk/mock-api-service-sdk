...
// MockApiService SDK metrics feature
...
class MockApiServiceMetricsFeature extends MockApiServiceBaseFeature
{
    ...
    private function _record(MockApiServiceContext $ctx, bool $ok): void
    {
