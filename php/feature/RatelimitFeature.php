...
// MockApiService SDK ratelimit feature
...
class MockApiServiceRatelimitFeature extends MockApiServiceBaseFeature
{
    ...
    private function _acquire(MockApiServiceContext $ctx): void
    {
    ...
    private function _track(MockApiServiceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
