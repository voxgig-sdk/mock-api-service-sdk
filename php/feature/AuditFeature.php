...
// MockApiService SDK audit feature
...
class MockApiServiceAuditFeature extends MockApiServiceBaseFeature
{
    ...
    private function _emit(MockApiServiceContext $ctx, string $outcome): void
    {
