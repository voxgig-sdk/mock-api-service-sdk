...
// MockApiService SDK cache feature
...
class MockApiServiceCacheFeature extends MockApiServiceBaseFeature
{
    ...
    private function _through(MockApiServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
