...
(0, node_test_1.describe)('UserEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.MockApiServiceSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.MockApiServiceSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.MockApiServiceSDK(merge([
