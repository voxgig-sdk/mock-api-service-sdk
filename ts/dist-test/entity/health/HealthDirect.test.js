...
(0, node_test_1.describe)('HealthDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('MOCK_API_SERVICE_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MockApiServiceSDK({
...
function liveScenariosActive() { return false && process.env.MOCK_API_SERVICE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MockApiServiceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MOCK_API_SERVICE_TEST_HEALTH_ENTID'];
    ...
    const client = new __1.MockApiServiceSDK({
        base: 'http://localhost:8080',
