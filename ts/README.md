# MockApiService TypeScript SDK



The TypeScript SDK for the MockApiService API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Health()` — each with a small set of operations (`list`, `load`, `create`, `update`, `remove`)
...
| `tester(testopts?, sdkopts?)` | `MockApiServiceSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `MockApiServiceSDK.test(testopts?, sdkopts?)` | `MockApiServiceSDK` | Create a test-mode client. |
...
| `client` | `client(): MockApiServiceSDK` | Return the parent SDK client. |
...
mock-api-service/
├── src/
│   ├── MockApiServiceSDK.ts        # Main SDK class
