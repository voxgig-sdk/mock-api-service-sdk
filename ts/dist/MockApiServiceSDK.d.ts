...
declare class MockApiServiceSDK {
    _mode: string;
    _options: any;
    _utility: Utility;
    _features: Feature[];
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): MockApiServiceSDK;
    tester(testopts?: any, sdkopts?: any): MockApiServiceSDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof MockApiServiceSDK;
export { stdutil, config, BaseFeature, MockApiServiceEntityBase, MockApiServiceSDK, SDK, };
