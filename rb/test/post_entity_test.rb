...
class PostEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = MockApiServiceSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MOCK_API_SERVICE_TEST_POST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def post_basic_setup(extra)
  ...
  entid_env_raw = ENV["MOCK_API_SERVICE_TEST_POST_ENTID"]
