...
class HealthEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MOCKAPISERVICE_TEST_HEALTH_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def health_basic_setup(extra)
  ...
  entid_env_raw = ENV["MOCKAPISERVICE_TEST_HEALTH_ENTID"]
