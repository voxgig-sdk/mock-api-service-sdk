...
#      offline in seeded test mode (MockApiServiceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MockApiService_sdk.rb")
  SDK_CLASS = "MockApiServiceSDK"
