# MockApiService SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MockApiServiceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MockApiServiceSDK(...) and MockApiServiceSDK.test(...) become
#      MockApiServiceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mockapiservice_sdk"
_SDK_CLASS = "MockApiServiceSDK"
