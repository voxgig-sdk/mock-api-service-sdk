...
from mockapiservice_sdk.utility import register

# Load features
from mockapiservice_sdk.feature.base_feature import MockApiServiceBaseFeature
from mockapiservice_sdk.features import _has_feature, _make_feature
...
class MockApiServiceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MockApiServiceUtility()
        self._utility = utility

        from mockapiservice_sdk.config import shared_config
    ...
    def get_utility(self):
        return MockApiServiceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MockApiServiceSDK: graphql: " + str(msg))
            res["graphql"] = errors
